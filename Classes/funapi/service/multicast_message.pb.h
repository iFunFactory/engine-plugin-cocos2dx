...
const FunMulticastMessage_ErrorCode FunMulticastMessage_ErrorCode_ErrorCode_MAX = FunMulticastMessage_ErrorCode_EC_CLOSED;
...
class FunMulticastChannelListMessage : public ::google::protobuf::Message {
 public:
