...
class FunDedicatedServerRpcMessage : public ::google::protobuf::Message {
 public:
 ...
 private:
  ...
  ::std::string* type_;
  bool is_request_;
  friend void  protobuf_AddDesc_funapi_2fdistribution_2ffun_5fdedicated_5fserver_5frpc_5fmessage_2eproto();
...
class FunDedicatedServerRpcSystemMessage : public ::google::protobuf::Message {
 public:
